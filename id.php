...
if(isset($_POST['submit'])){
    ...
    $sql=" INSERT INTO orders (fname, lname, fatherN, motherN, blood, pob, por, regNb, dob, type, martial, image, email) VALUES ('$fname','$lname', '$fatherN', '$motherN', '$blood', '$pob', '$por', '$regNb', '$dob','$type', '$martial', '$image', '$email') ";
            ...
            <div class="data">
                <div class="input-container">
                    ...
                    <label>Document Type:</label>
                        ...
                        <label for="name" class="name">Martial Status:</label>
                        <select name="martial" >
                        ...
                        <label for="name" class="name">Registration Number:</label>
                        <input placeholder="Enter father's name" type="text" name="regNb" class="input">
                        <div class="underline"></div>
                        
                        <button name="submit" class="btn-apply" value="submit" >Submit</button>
                    </form>
                    </div>
                    <div class="id-sample">
                        <label  class="id-img-header">Sample ID</label>
                        <img  src="img\id.jpeg">
                    </div>
                </div> 
            </div>
