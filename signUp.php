...
require_once 'connection.php';
    ...
    if(isset($_POST['submit'])){
        ...
        $sql=" INSERT INTO user (fname, lname, email, password, phoneNb, id) VALUES ('$fname','$lname', '$email', '$password', '$phoneNb', '') ";
        ...
        <div class="wrapper">
            ...
            <div class="form-container">
                ...
                <form class="form" method="post" action="signUp.php">
                    ...
                    <input type="text" class="input" placeholder="Enter first name" name="fname" required>
                    <label>Last Name</label>
                    <input type="text" class="input" placeholder="Enter last name" name="lname" required>
                    <label>Phone Number</label>
                    <input type="tel" class="input" placeholder="Enter phone number" name="phoneNb"required>
                    <label>Email</label>
                    ...
                    <button class="form-btn" id="name" name="submit" value="Submit">Submit</button>
                </form>
            </div>
