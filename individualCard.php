...
if(isset($_POST['submit'])){
    ...
    $sql= "INSERT INTO orders (fname, lname, fatherN, motherN, por, pob, religion, governate, martial, neighborhood, phoneNb, type, image, email, dob) VALUES ('$fname','$lname', '$fatherN', '$motherN', '$por', '$pob', '$religion', '$governate', '$martial', '$neighborhood', '$phoneNb', '$type', '$image', '$email', '$dob') ";
        ...
        <div class="wrapper">
            ...
            <div class="data">
                <div class="input-container">
                    <form action="individualCard.php" method="post">
                    <label>Document Type:</label>
                        ...
                        <input placeholder="Enter phone number" type="tel" name="phoneNb" class="input">
                        <div class="underline"></div>
                    ...
                    <div class="id-sample">
                        ...
                        <img class="img-card" src="img\155263Image1-1180x677_d.jpg">
                    </div>
                </div> 
            </div>
            <!-- Data End -->
