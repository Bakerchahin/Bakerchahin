        ...
        <div class="wrapper">
            ...
            <div class="data">
                <div class="input-container">
                    <form action="birthCertificate.php" method="post">
                    ...
                    <label>Document Type:</label>
                        ...
                        <input placeholder="Enter registration number" type="text" name="regNb" class="input">
                        <div class="underline"></div>
                        ...
                        <label for="name" class="name" >1st Witness:</label>
                        <input type="text" class="input" placeholder="Enter full name" name="witness1">
                        <div class="underline"></div>

                        <label for="name" class="name" >2nd Witness:</label>
                        <input type="text" class="input" placeholder="Enter full name" name="witness2">
                        <div class="underline"></div>
                    ...
                    <div class="id-sample">
                        <label  class="id-img-header">Sample Individual Card</label>
                        <img class="img-card" src="img\birth-certificate.png">
                    </div>
                </div> 
            </div>
            <!-- Data End -->
